...
namespace Viking {
    ...
    void Renderer::pickPhysicalDevice() {
        ...
        vkEnumeratePhysicalDevices(Vulkan::Context::getInstance(), &deviceCount, nullptr);
        ...
        vkEnumeratePhysicalDevices(Vulkan::Context::getInstance(), &deviceCount, devices.data());
    ...
    QueueFamilyIndices Renderer::findQueueFamilies(VkPhysicalDevice device) {
        ...
        for (const auto& queueFamily : queueFamilies) {
            ...
            vkGetPhysicalDeviceSurfaceSupportKHR(device, i, Vulkan::Context::getSurface(), &presentSupport);
    ...
    SwapChainSupportDetails Renderer::querySwapChainSupport(VkPhysicalDevice device) {
        ...
        vkGetPhysicalDeviceSurfaceCapabilitiesKHR(device, Vulkan::Context::getSurface(), &details.capabilities);

        uint32_t formatCount;
        vkGetPhysicalDeviceSurfaceFormatsKHR(device, Vulkan::Context::getSurface(), &formatCount, nullptr);

        if (formatCount != 0) {
            details.formats.resize(formatCount);
            vkGetPhysicalDeviceSurfaceFormatsKHR(device, Vulkan::Context::getSurface(), &formatCount, details.formats.data());
        }

        uint32_t presentModeCount;
        vkGetPhysicalDeviceSurfacePresentModesKHR(device, Vulkan::Context::getSurface(), &presentModeCount, nullptr);

        if (presentModeCount != 0) {
            details.presentModes.resize(presentModeCount);
            vkGetPhysicalDeviceSurfacePresentModesKHR(device, Vulkan::Context::getSurface(), &presentModeCount, details.presentModes.data());
        }
