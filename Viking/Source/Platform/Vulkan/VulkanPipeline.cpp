...
namespace Viking {
    VulkanPipeline::VulkanPipeline(const Ref<VulkanSwapchain>& swapchain, const Ref<VulkanLogicalDevice>& logicalDevice, const Ref<VulkanPhysicalDevice>& physicalDevice, const std::string& vertexShaderPath, const std::string& fragmentShaderPath): m_LogicalDevice(logicalDevice) {
    ...
    void VulkanPipeline::createDescriptorSetLayout() {
        ...
        if (vkCreateDescriptorSetLayout(m_LogicalDevice->getDevice(), &layoutInfo, nullptr, &m_DescriptorSetLayout) != VK_SUCCESS) {
    ...
    std::vector<char> VulkanPipeline::readFile(const std::string& filename) {
        ...
        VI_ASSERT(!file.is_open(), "Failed to open shader file!");
