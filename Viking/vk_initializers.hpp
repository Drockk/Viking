...
namespace vkinit
{
    ...
    VkSubmitInfo submit_info(const VkCommandBuffer* cmd);
    ...
    VkWriteDescriptorSet write_descriptor_image(VkDescriptorType type, VkDescriptorSet dstSet, const VkDescriptorImageInfo* imageInfo, uint32_t binding);
}
